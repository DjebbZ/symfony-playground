...
use Djebbz\TicketBundle\Model\UserPeer;
use Djebbz\TicketBundle\Model\map\TicketTableMap;

abstract class BaseTicketPeer
{

    /** the default database name for this class */
    const DATABASE_NAME = 'symfony-playground';

    /** the table name for this class */
    const TABLE_NAME = 'ticket';

    /** the related Propel class for this table */
    const OM_CLASS = 'Djebbz\\TicketBundle\\Model\\Ticket';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Description', 'UserId', 'CreatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'description', 'userId', 'createdAt', ),
        BasePeer::TYPE_COLNAME => array (TicketPeer::ID, TicketPeer::TITLE, TicketPeer::DESCRIPTION, TicketPeer::USER_ID, TicketPeer::CREATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'DESCRIPTION', 'USER_ID', 'CREATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'description', 'user_id', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Description' => 2, 'UserId' => 3, 'CreatedAt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'userId' => 3, 'createdAt' => 4, ),
        BasePeer::TYPE_COLNAME => array (TicketPeer::ID => 0, TicketPeer::TITLE => 1, TicketPeer::DESCRIPTION => 2, TicketPeer::USER_ID => 3, TicketPeer::CREATED_AT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'DESCRIPTION' => 2, 'USER_ID' => 3, 'CREATED_AT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'user_id' => 3, 'created_at' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TicketPeer::TITLE);
