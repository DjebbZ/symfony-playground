...
use Djebbz\TicketBundle\Model\UserQuery;
...
abstract class BaseTicket extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Djebbz\\TicketBundle\\Model\\TicketPeer';
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = TicketPeer::TITLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = TicketPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCreator !== null && $this->user_id !== $this->aCreator->getId()) {
            $this->aCreator = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TicketPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(TicketPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(TicketPeer::USER_ID)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCreator) {
                $result['Creator'] = $this->aCreator->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TicketPeer::TITLE)) $criteria->add(TicketPeer::TITLE, $this->title);
     ...
     * @throws PropelException
     */
    public function getCreator(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCreator === null && ($this->user_id !== null) && $doQuery) {
            $this->aCreator = UserQuery::create()->findPk($this->user_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCreator->addTickets($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCreator instanceof Persistent) {
              $this->aCreator->clearAllReferences($deep);
            }
